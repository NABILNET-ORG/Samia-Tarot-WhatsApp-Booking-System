    ...
    <div className="h-full overflow-y-auto">
      ...
      <div className="p-6 border-b border-gray-200">
        <div className="flex flex-col items-center">
          ...
          {customer.vip_status && (
            <span className="mt-2 px-3 py-1 bg-yellow-100 text-yellow-800 text-xs font-semibold rounded-full">
              VIP Customer
            </span>
          )}
        </div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-50 rounded-lg p-3">
              ...
              <p className="text-2xl font-bold text-gray-900">{customer.total_bookings || 0}</p>
            </div>
            <div className="bg-gray-50 rounded-lg p-3">
        ...
        {/* Customer Since */}
        <div>
          <h3 className="text-sm font-semibold text-gray-900 mb-2">Customer Since</h3>
