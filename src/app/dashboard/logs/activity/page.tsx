                    ...
                    {logs.map((log) => (
                      <tr key={log.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm">
                          ...
                          <div className="text-gray-500 text-xs">{log.resource_id?.substring(0, 8)}...</div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm">
                          <div className="text-gray-900">{log.employee?.full_name}</div>
                          <div className="text-gray-500 text-xs">{log.employee?.email}</div>
                        </td>
